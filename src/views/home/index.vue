<template>
	<div id="index" class="page">
		<section class="nav mui-row" :class="{bgcolor:bgcolor,scroll}">
			<div class="nav-logo mui-col-xs-2"><img src="../../../static/images/logo.png"></div>
			<div class="nav-search mui-col-xs-8">
				<router-link to="/search" >
				<div class="nav-one" >
				<img src="../../assets/images/search.png"><p>粉米卡</p></div>
					</router-link>
		...
		<section class="page03">
			<ul class="mui-row page03-content">
				...
				<li class="mui-col-xs-8 page03-right">
					<!-- <span>小米5c直降200，抢购吧......</span>
					<span style="display: none;">红米5A直降200，抢购吧......</span> -->
					<mt-swipe :auto="2000" :show-indicators="false">
  						<mt-swipe-item v-for="daily in daily_data">{{daily.daily_name}}</mt-swipe-item>
  						<!-- <mt-swipe-item>红米5A直降200，抢购吧......</mt-swipe-item> -->
  					</mt-swipe>
				</li>
			</ul>
		</section>
...
export default {
  ...
  created(){
  	...
  	Axios.get('/api/xiaomi').then( rtnD => {
  		 this.advert_list = rtnD.data
  	})
  
  	Axios.get('/api/daily').then( rtnD => {
  		 this.daily_data = rtnD.data
