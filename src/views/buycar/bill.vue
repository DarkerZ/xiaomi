<template>
	<div>
    <Head headTitle="用户结算" class="header"></Head>
		...
		<div class="goods">
			<ul class="mui-table-view">
    			<li class="mui-table-view-cell mui-media" v-for="goods in buyList">
        			<div>
            			<img class="mui-media-object mui-pull-left"  :src='goods.goods_image'>
            			<div class="mui-media-body">
                			<span class="c1"> {{ goods.goods_name }}</span>
...
export default {
  ...
  computed: {
      ...mapState(['buyList','addressInfo']),//映射 
